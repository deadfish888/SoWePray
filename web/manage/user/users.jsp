                                                                ...
                                                                <div class="noidung_dropdown">
                                                                    <c:choose>
                                                                        <c:when test="${s.is_super()==0}">
                                                                            <a><button class="btn btn-primary" name="id_up" value="${s.getId()}" type="submit"><i class="fa-solid fa-up-long"></i></button></a>
                                                                                </c:when>
                                                                                <c:when test="${s.is_super()+1==sessionScope.admin.is_super()}">
                                                                            <a><button class="btn btn-primary" name="id_down" value="${s.getId()}" type="submit"><i class="fa-solid fa-down-long"></i></button></a>
                                                                            <a><button class="btn btn-primary" name="id_ban" value="${s.getId()}" type="submit"><i class="fa-solid fa-user-slash"></i></button></a>
                                                                                </c:when>
                                                                                <c:otherwise>
                                                                            <a><button class="btn btn-primary" name="id_up" value="${s.getId()}" type="submit"><i class="fa-solid fa-up-long"></i></button></a>
                                                                            <a><button class="btn btn-primary" name="id_down" value="${s.getId()}" type="submit"><i class="fa-solid fa-down-long"></i></button></a>
